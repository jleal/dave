...
describe BooksController do
  ...
  describe "GET index" do
    it "assigns all books as @books" do
      ...
      get :index, {:controller_type => :books}, valid_session
  ...
  describe "GET show" do
    it "assigns the requested book as @book" do
      book = Book.create! valid_attributes
      get :show, {:id => book.to_param, :controller_type => :books}, valid_session
  ...
  describe "GET new" do
    it "assigns a new book as @book" do
      get :new, {:controller_type => :books}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested book as @book" do
      book = Book.create! valid_attributes
      get :edit, {:id => book.to_param, :controller_type => :books}, valid_session
      assigns(:book).should eq(book)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Book" do
        expect {
          post :create, {:book => valid_attributes, :controller_type => :books}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved book as @book" do
        ...
        post :create, {:book => {}, :controller_type => :books}, valid_session
        assigns(:book).should be_a_new(Book)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested book" do
        pending "Not working for some reason will fix later"
        book = Book.create! valid_attributes
        ...
        put :update, {:id => book.to_param, 
          :book => {'these' => 'params'},
          :controller_type => :books}, valid_session
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested book" do
      book = Book.create! valid_attributes
      expect {
        delete :destroy, {:id => book.to_param, :controller_type => :books}, valid_session
      }.to change(Book, :count).by(-1)
    end
  ...
  #==> SPECS FOR HANDLING FUNKY BOOK REQUESTS
  describe "GET index" do
